...
<body>
        ...
        <a href="/Super-admin-main/adventours/restaurants_reservation.php" class="btn active" onclick="toggleButtonUnderline(this, 'restaurants'); return true;">Restaurants</a> 
    </div>
...
<script>
    ...
    function AddItemToTable(reservationId, CustomerName, RestaurantName, Guests, Date, Time, receipt, status, action) {
    ...
    td3.innerHTML = RestaurantName;

    var td4 = document.createElement('td');
    td4.innerHTML = Guests;

     var td5 = document.createElement('td');
    td5.innerHTML = Date || "<span class='text-danger'>No date</span>";

    var td6 = document.createElement('td');
    td6.innerHTML = Time || "<span class='text-danger'>No time</span>";
...
dropdownMenu.addEventListener('click', function(event) {
    ...
    if (target.tagName === 'A') {
        ...
        db.collection("Restaurant Reservation").doc(reservationId).update({
...
function notifyUser(status) {
    ...
    function AddAllItemsToTheTable(RestaurantReservationDocsList) {
        ...
        RestaurantReservationDocsList.forEach(element => {
            AddItemToTable(element.reservationId, element.CustomerName, element.RestaurantName, element.Guests, element.Date, element.Time, element.receipt, element.status, element.action);
        });
    }
    ...
    window.onload = GetAllDataOnce;
     ...
     function GetAllDataOnce() {
        db.collection("Restaurant Reservation").get().then((querySnapshot) => {
...
<script>
    ...
    function listenForNewReservations() {
        ...
        var reservationsRef = db.collection("Restaurant Reservation");
